...
if __name__ == "__main__":
    ...
    train_triplet("dataset", weights_dir="checkpoints_d2/epoch-47-loss-0.16744-acc-95.76.pth", epochs=50,
                  checkpoint_dir="checkpoints_triplet", run_name="run2", on_gpu=True)
